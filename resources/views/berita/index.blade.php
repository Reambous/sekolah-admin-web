                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        <div class="flex flex-wrap items-center gap-3">
                            <h3 class="text-xl font-bold text-gray-900 whitespace-nowrap">Daftar Berita</h3>

                            @if (Auth::user()->role == 'admin')
                                <div class="flex items-center gap-2 border-l pl-3 border-gray-300 m-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @forelse($berita as $item)
                            <div
                                ...
                                <div
                                    class="mt-auto pt-4 border-t border-gray-100 flex justify-between items-center text-sm">
                                    {{-- Total Komentar --}}
