<x-app-layout>
                        ...
                        <div class="flex flex-wrap gap-2 mt-4 pt-3 border-t border-gray-100">
                            ...
                            @if (Auth::user()->role == 'admin')
                                @if ($item->status == 'pending')
                                    <form action="{{ route('sarpras.kegiatan.approve', $item->id) }}" method="POST">
                                        @csrf @method('PATCH')
                                        <button type="submit"
                                ...
                                @elseif ($item->status == 'disetujui')
                                    <form action="{{ route('sarpras.kegiatan.unapprove', $item->id) }}" method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-10 text-center text-gray-400 italic bg-gray-50">
                                    Belum ada data kegiatan sarpras.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <form id="bulk-delete-form" action="{{ route('sarpras.kegiatan.bulk_delete') }}" method="POST">@csrf</form>
    <script>
