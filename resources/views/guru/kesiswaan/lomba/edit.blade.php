<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Edit Lomba Tim / Individu') }}</h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('kesiswaan.lomba.update', $lomba->id) }}" method="POST">
                        ...
                        <div x-data="{ rows: {{ Js::from($formattedPeserta) }} }">

                            <div class="flex justify-between items-end mb-2">
                                <div>
                                    <h3 class="font-bold text-gray-700">Daftar Peserta</h3>
                                    <p class="text-xs text-gray-500">Edit nama atau tambah kelas baru.</p>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-3 align-top">
                                                    <input type="text" :name="'peserta[' + index + '][kelas]'"
                                                        ...
                                                        class="w-full rounded-md border-gray-300 text-sm focus:ring-blue-500 uppercase"
                                                        required>
                                                </td>

                                                <td class="px-4 py-3 align-top">
                                                    <textarea :name="'peserta[' + index + '][nama]'" x-model="row.nama" rows="2" placeholder="Cth: Budi, Siti..."
                                                        class="w-full rounded-md border-gray-300 text-sm focus:ring-blue-500" required></textarea>
                                                </td>
